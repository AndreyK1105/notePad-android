...
import com.example.mynotepad.Greeting
import com.example.mynotepad.MainActivity2
...
//private val viewModel by mutableStateOf<DashBoardUiState>()
...
MaterialTheme {
//FloatingActionButton(onClick = { findNavController().navigate(DashboardFragmentDirections.actionNavigationDashboardToMyFragment()) }) {

//}
    Greeting(name = "New dashboard", vm = viewModel)
}
